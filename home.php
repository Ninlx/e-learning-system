...
<div class="col-lg-12">
  <h4>Mandate</h4>
  <p> The Capiz State University (CAPSU) primarily provides advance instruction and professional training in
    agriculture, fishery and forestry, science and technology, arts and humanities, education and other related fields.
    It shall also undertake research, extension services and production activities and provide progressive leadership in
    its areas of specialization.</p>
</div>
<div class="col-lg-6">
  <h4>Vision</h4>
  <p>Center of Academic Excellence Delivering Quality Service to all.</p>
  <h4>Mission</h4>
  <p> Capiz State University is committed to provide advanced knowledge and innovation; develop skills, talents and
    values; undertake relevant research; development and extension services; promote entrepreneurship and environmental
    consciousness; and enhance industry collaboration & linkages with partner agencies.</p>
  <h4>Goals</h4>
  <ol>
...
<div class="col-lg-6">
  ...
  <ol>
    ...
    <li>Continuing innovations and quality improvement cultivating an efficient and effective and environment for
      maximum clientele satisfaction;</li>
